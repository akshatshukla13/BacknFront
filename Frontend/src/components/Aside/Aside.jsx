...
function Aside() {
  return (
    <aside class="  text-white group bottom-0 z-40 w-full shrink-0 border-t border-white bg-[#121212] px-2  sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px] lg:sticky lg:max-w-[250px] sticky left-0 top-0 ">
